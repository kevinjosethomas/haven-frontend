...
export const TargetCard = props => {
  ...
  return (
    ...
    cursor-default rounded transform transition duration-500 hover:scale-103">
      ...
      <div className="flex flex-col items-start justify-center px-5 lg:px-6 xl:px-6 2xl:px-10 w-full h-3/4 bg-light-300 bg-opacity-20 space-y-5 lg:space-y-3 xl:space-y- rounded-b">
        { props.content.map(item => (
          <div key={item.text} className="font-inter font-medium text-md md:text-xs lg:text-lg 3xl:text-2xl text-gray-500">
