...
export const TargetCard = props => {
  ...
  return (
    <div className="TargetCard flex flex-col items-center justify-between mx-12 w-96 w-card-target-large h-card-target-large">
      <div className="flex flex-row items-end justify-start px-10 py-6 w-full h-1/4 bg-light-400">
      ...
      <div className="flex flex-col items-start justify-center px-10 w-full h-3/4 space-y-5 bg-light-300">
