...
export const TargetCard = props => {
  ...
  return (
    <div className="TargetCard flex flex-col items-center justify-between w-96 w-card-target-large h-card-target-large cursor-default rounded transform transition duration-500 hover:scale-103">
