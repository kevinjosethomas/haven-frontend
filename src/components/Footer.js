    ...
    return (
        ...
        <div className="mt-4 items-center">
            ...
            <div class="px-2 pt-2 pb-3 space-y-1">
                <span className={`cursor-pointer font-lg font-bold ${router.pathname == "/team" ? "text-gray-500" : "text-gray-500 hover:text-gray-400"} mr-6`} >Team</span>
                <span className={`cursor-pointer font-lg font-bold ${router.pathname == "/partners" ? "text-gray-500" : "text-gray-500 hover:text-gray-400"} mr-6`} >Partners</span>
                <span className={`cursor-pointer font-lg font-bold ${router.pathname == "/privacy" ? "text-gray-500" : "text-gray-500 hover:text-gray-400"} mr-6`} >Privacy Policy</span>
                <span className={`cursor-pointer font-lg font-bold ${router.pathname == "/terms" ? "text-gray-500" : "text-gray-500 hover:text-gray-400"} mr-6`} >Terms</span>
                </div>
