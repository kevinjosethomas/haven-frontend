...
const Index = props => {
  ...
  return (
    <Layout>
      <div className="flex flex-row items-center justify-end md:py-5 2xl:py-10 3xl:py-14 3xl:pb-10">
      ...
      <div className="flex flex-col items-center justify-center w-full h-section lg:h-section-lg-alt 3xl:h-section bg-dark-100">
      ...
      <div className="flex flex-col items-center justify-center w-full h-mini-section text-center bg-dark-100">
        <div className="flex flex-row items-center justify-center mb-2">
          <i className="fas fa-rocket-launch mr-2 text-7xl lg:text-8xl xl:text-9xl text-gray-300" />
          <span className="ml-2 font-acumin font-bold text-7xl lg:text-8xl xl:text-9xl text-gray-300">Get Started</span>
        </div>
        <p
          className="my-3 max-w-xl lg:max-w-2xl xl:max-w-3xl font-inter font-medium text-2xl lg:text-3xl xl:text-4xl text-gray-400"
        >Create your profile to start meeting new people and showing off your work!</p>
        <div className="flex flex-col items-center justify-center mt-5 py-3 lg:py-5 px-8 bg-blue-500 rounded cursor-pointer transform transition duration-500 hover:scale-105">
